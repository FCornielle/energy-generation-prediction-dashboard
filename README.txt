...
Este repositorio contiene el proyecto para la creación de un dashboard de predicción de generación de energía, haciendo uso de Power BI y Azure. Incluye la extracción de datos desde el API del organismo coordinador, su limpieza y preprocesamiento local, y la implementación de pipelines de datos en Azure Data Factory. El objetivo final es desplegar un dashboard en Power BI que muestre la información procesada y los modelos predictivos entrenados.
...
│   └── evaluation/            <- Scripts de evaluación, métricas y validaciones
│
